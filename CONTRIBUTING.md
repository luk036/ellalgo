...
If you experience bugs or general issues with `ellalgo`, please have a look
...
You can help improve `ellalgo` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`ellalgo` documentation uses [Sphinx] as its main documentation compiler.
...
The documentation uses MyST (Markdown with Sphinx extensions).
   ...
   :::{tip}
      ...
      propose changes in `ellalgo`'s files. While this mechanism can
...
```
conda create -n ellalgo python=3 six virtualenv pytest pytest-cov
conda activate ellalgo
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/ellalgo.git
   cd ellalgo
   ```
...
5. Install [pre-commit]:
   ...
   `ellalgo` comes with a lot of hooks configured to automatically help the
