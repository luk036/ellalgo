...
@st.composite
def valid_profit_params(draw: DrawFn) -> tuple[float, float, float]:
...
@st.composite
def valid_elasticities(draw: DrawFn) -> np.ndarray:
...
@st.composite
def valid_price_out(draw: DrawFn) -> np.ndarray:
...
@st.composite
def valid_solution_point(draw: DrawFn) -> np.ndarray:
