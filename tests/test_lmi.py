...
from ellalgo.oracles.lmi_old_oracle import lmi_old_oracle
from ellalgo.oracles.lmi_oracle import lmi_oracle
...
def run_lmi(oracle):
    ...
    E = ell(10.0, x0)
    P = my_oracle(oracle)
    x, _, num_iters, _ = cutting_plane_optim(P, E, float("inf"))
    # time.sleep(duration)
