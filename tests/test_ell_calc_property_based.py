...
class TestEllCalcProperties:
    ...
    def test_central_cut_properties(self, n, beta, tsq):
        ...
        status_single, result_single = calc.calc_single_or_parallel_central_cut(beta, tsq)
    ...
    def test_parallel_central_cut_properties(self, n, beta0, beta1, tsq):
        ...
        status_parallel, result_parallel = calc.calc_single_or_parallel_central_cut(beta_list, tsq)
    ...
    def test_single_vs_parallel_consistency(self, n, beta, tsq):
        ...
        assert status_single in [CutStatus.Success, CutStatus.NoSoln, CutStatus.NoEffect]
        assert status_parallel in [CutStatus.Success, CutStatus.NoSoln, CutStatus.NoEffect]
