...
module_dir = os.path.join(__location__, "../src/ellalgo")
try:
...
try:
    from ellalgo import __version__ as version
except ImportError:
    version = ""
...
latex_documents = [
    ("index", "user_guide.tex", "ellalgo Documentation", "Wai-Shing Luk", "manual")
]
